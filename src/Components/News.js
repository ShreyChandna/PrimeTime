    ...
    category: PropTypes.string,
      ...
      constructor()
       ...
       async componentDidMount(){
            let url =`https://newsapi.org/v2/top-headlines?country=in&category=${this.props.category}&apiKey=2a95bdcaccfb4fbab0cfef06a58b699b&page=1&pageSize=${this.props.pageSize}`;
        ...
        handlePrevious= async()=>{
            let url =`https://newsapi.org/v2/top-headlines?country=in&category=${this.props.category}&apiKey=2a95bdcaccfb4fbab0cfef06a58b699b&page=${this.state.page -1}&pageSize=${this.props.pageSize}`;
            this.setState({loading : true});
            let data=await fetch(url);
            let parsedData=await data.json();
            this.setState({
